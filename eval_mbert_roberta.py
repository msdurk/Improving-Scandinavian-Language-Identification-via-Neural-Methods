...
class Open2LanguageIdentifier(AbstractLanguageIdentifier):
    def __init__(self, args):
        super().__init__(args)
        import fasttext
...
class CustomOpenXLMModel(AbstractLanguageIdentifier):
    def __init__(self, args):
        super().__init__(args)
        import fasttext
        self.args = args
...
def main():
    ...
    elif args.method == "open":
        identifier = Open2LanguageIdentifier(args)
    elif args.method == "openxml":
        identifier == CustomOpenXLMModel(args)
    else:
